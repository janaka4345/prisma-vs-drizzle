...
-- CreateIndex
CREATE UNIQUE INDEX "Payment_status_status_key" ON "Payment_status"("status");

-- CreateIndex
CREATE UNIQUE INDEX "Room_room_number_key" ON "Room"("room_number");

-- CreateIndex
CREATE UNIQUE INDEX "Addon_addon_name_key" ON "Addon"("addon_name");

-- CreateIndex
CREATE UNIQUE INDEX "Floor_floor_number_key" ON "Floor"("floor_number");

-- CreateIndex
CREATE UNIQUE INDEX "Room_class_base_price_class_name_key" ON "Room_class"("base_price", "class_name");

-- CreateIndex
CREATE UNIQUE INDEX "Room_status_status_key" ON "Room_status"("status");

-- CreateIndex
CREATE UNIQUE INDEX "Bed_type_bed_type_key" ON "Bed_type"("bed_type");
