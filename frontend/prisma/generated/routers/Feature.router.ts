...
export const featuresRouter = t.router({
  ...
  groupByFeature: publicProcedure
    .input(FeatureGroupBySchema).query(async ({ ctx, input }) => {
  ...
  updateManyFeature: publicProcedure
    .input(FeatureUpdateManySchema).mutation(async ({ ctx, input }) => {
