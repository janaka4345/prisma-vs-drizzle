...
const Schema: z.ZodType<Prisma.roomclass_featureCreateNestedManyWithoutRoom_classInput> =
    z
        .object({
            create: z
                .union([
...
export const roomclass_featureCreateNestedManyWithoutRoom_classInputObjectSchema =
    Schema
