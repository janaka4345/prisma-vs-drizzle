...
const Schema: z.ZodType<Prisma.roomclass_featureUpdateManyWithoutFeatureNestedInput> =
    z
        .object({
            create: z
                .union([
...
export const roomclass_featureUpdateManyWithoutFeatureNestedInputObjectSchema =
    Schema
