...
const Schema: z.ZodType<Prisma.room_class_bed_typeUpdateManyWithoutBed_typeNestedInput> =
    z
        .object({
            create: z
                .union([
...
export const room_class_bed_typeUpdateManyWithoutBed_typeNestedInputObjectSchema =
    Schema
