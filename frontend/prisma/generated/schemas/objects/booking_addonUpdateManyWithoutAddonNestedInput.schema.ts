...
const Schema: z.ZodType<Prisma.booking_addonUpdateManyWithoutAddonNestedInput> =
    z
        .object({
            create: z
                .union([
...
export const booking_addonUpdateManyWithoutAddonNestedInputObjectSchema = Schema
