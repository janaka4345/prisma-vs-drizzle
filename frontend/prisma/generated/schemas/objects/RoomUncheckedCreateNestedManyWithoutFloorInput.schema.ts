...
const Schema: z.ZodType<Prisma.RoomUncheckedCreateNestedManyWithoutFloorInput> =
    z
        .object({
            create: z
                .union([
...
export const RoomUncheckedCreateNestedManyWithoutFloorInputObjectSchema = Schema
