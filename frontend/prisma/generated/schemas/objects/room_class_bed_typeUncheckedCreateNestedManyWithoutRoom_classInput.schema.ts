...
const Schema: z.ZodType<Prisma.room_class_bed_typeUncheckedCreateNestedManyWithoutRoom_classInput> =
    z
        .object({
            create: z
                .union([
...
export const room_class_bed_typeUncheckedCreateNestedManyWithoutRoom_classInputObjectSchema =
    Schema
