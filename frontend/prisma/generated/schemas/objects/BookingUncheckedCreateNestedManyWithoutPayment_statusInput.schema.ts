...
const Schema: z.ZodType<Prisma.BookingUncheckedCreateNestedManyWithoutPayment_statusInput> =
    z
        .object({
            create: z
                .union([
...
export const BookingUncheckedCreateNestedManyWithoutPayment_statusInputObjectSchema =
    Schema
