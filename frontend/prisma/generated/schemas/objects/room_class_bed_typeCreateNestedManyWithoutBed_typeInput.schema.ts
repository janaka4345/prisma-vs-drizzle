...
const Schema: z.ZodType<Prisma.room_class_bed_typeCreateNestedManyWithoutBed_typeInput> =
    z
        .object({
            create: z
                .union([
...
export const room_class_bed_typeCreateNestedManyWithoutBed_typeInputObjectSchema =
    Schema
