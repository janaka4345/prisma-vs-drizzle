...
const Schema: z.ZodType<Prisma.BookingUncheckedUpdateWithoutBooking_roomInput> =
    z
        .object({
            id: z
                .union([
...
export const BookingUncheckedUpdateWithoutBooking_roomInputObjectSchema = Schema
