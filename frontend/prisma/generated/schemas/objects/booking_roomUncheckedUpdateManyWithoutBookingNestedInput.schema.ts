...
const Schema: z.ZodType<Prisma.booking_roomUncheckedUpdateManyWithoutBookingNestedInput> =
    z
        .object({
            create: z
                .union([
...
export const booking_roomUncheckedUpdateManyWithoutBookingNestedInputObjectSchema =
    Schema
