...
const Schema: z.ZodType<Prisma.room_class_bed_typeUncheckedUpdateManyWithoutRoom_classNestedInput> =
    z
        .object({
            create: z
                .union([
...
export const room_class_bed_typeUncheckedUpdateManyWithoutRoom_classNestedInputObjectSchema =
    Schema
