...
const Schema: z.ZodType<Prisma.booking_roomUncheckedUpdateManyWithoutRoomNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(
                        () => booking_roomCreateWithoutRoomInputObjectSchema
                    ),
                    z
                        .lazy(
                            () => booking_roomCreateWithoutRoomInputObjectSchema
...
export const booking_roomUncheckedUpdateManyWithoutRoomNestedInputObjectSchema =
    Schema
