...
const Schema: z.ZodType<Prisma.booking_addonUpdateManyWithWhereWithoutAddonInput> =
    z
        .object({
...
export const booking_addonUpdateManyWithWhereWithoutAddonInputObjectSchema =
    Schema
