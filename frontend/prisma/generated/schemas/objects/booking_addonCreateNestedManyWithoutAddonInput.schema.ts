...
const Schema: z.ZodType<Prisma.booking_addonCreateNestedManyWithoutAddonInput> =
    z
        .object({
            create: z
                .union([
...
export const booking_addonCreateNestedManyWithoutAddonInputObjectSchema = Schema
