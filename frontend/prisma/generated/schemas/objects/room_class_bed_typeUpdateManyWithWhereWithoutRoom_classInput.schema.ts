...
const Schema: z.ZodType<Prisma.room_class_bed_typeUpdateManyWithWhereWithoutRoom_classInput> =
    z
        .object({
            where: z.lazy(
...
export const room_class_bed_typeUpdateManyWithWhereWithoutRoom_classInputObjectSchema =
    Schema
