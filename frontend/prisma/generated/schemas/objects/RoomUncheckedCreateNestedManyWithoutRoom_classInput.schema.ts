...
const Schema: z.ZodType<Prisma.RoomUncheckedCreateNestedManyWithoutRoom_classInput> =
    z
        .object({
            create: z
                .union([
...
export const RoomUncheckedCreateNestedManyWithoutRoom_classInputObjectSchema =
    Schema
