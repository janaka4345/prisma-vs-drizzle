...
const Schema: z.ZodType<Prisma.booking_addonUncheckedCreateNestedManyWithoutBookingInput> =
    z
        .object({
            create: z
                .union([
...
export const booking_addonUncheckedCreateNestedManyWithoutBookingInputObjectSchema =
    Schema
