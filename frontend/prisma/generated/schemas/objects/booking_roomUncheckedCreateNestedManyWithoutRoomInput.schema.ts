...
const Schema: z.ZodType<Prisma.booking_roomUncheckedCreateNestedManyWithoutRoomInput> =
    z
        .object({
            create: z
                .union([
...
export const booking_roomUncheckedCreateNestedManyWithoutRoomInputObjectSchema =
    Schema
