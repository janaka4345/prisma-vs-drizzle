...
const Schema: z.ZodType<Prisma.BookingUncheckedCreateNestedManyWithoutGuestInput> =
    z
        .object({
            create: z
                .union([
...
export const BookingUncheckedCreateNestedManyWithoutGuestInputObjectSchema =
    Schema
