...
const Schema: z.ZodType<Prisma.roomclass_featureUpdateManyWithWhereWithoutRoom_classInput> =
    z
        .object({
...
export const roomclass_featureUpdateManyWithWhereWithoutRoom_classInputObjectSchema =
    Schema
