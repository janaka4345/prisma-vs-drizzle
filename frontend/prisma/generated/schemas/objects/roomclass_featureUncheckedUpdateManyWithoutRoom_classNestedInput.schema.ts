...
const Schema: z.ZodType<Prisma.roomclass_featureUncheckedUpdateManyWithoutRoom_classNestedInput> =
    z
        .object({
            create: z
                .union([
...
export const roomclass_featureUncheckedUpdateManyWithoutRoom_classNestedInputObjectSchema =
    Schema
