...
const Schema: z.ZodType<Prisma.roomclass_featureCreateNestedManyWithoutFeatureInput> =
    z
        .object({
            create: z
                .union([
...
export const roomclass_featureCreateNestedManyWithoutFeatureInputObjectSchema =
    Schema
