...
const Schema: z.ZodType<Prisma.booking_addonUncheckedUpdateManyWithoutBookingNestedInput> =
    z
        .object({
            create: z
                .union([
...
export const booking_addonUncheckedUpdateManyWithoutBookingNestedInputObjectSchema =
    Schema
