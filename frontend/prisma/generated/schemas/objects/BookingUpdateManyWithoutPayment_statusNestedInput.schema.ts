...
const Schema: z.ZodType<Prisma.BookingUpdateManyWithoutPayment_statusNestedInput> =
    z
        .object({
            create: z
                .union([
...
export const BookingUpdateManyWithoutPayment_statusNestedInputObjectSchema =
    Schema
